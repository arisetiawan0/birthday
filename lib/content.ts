...
export const galeri = {
  ...
  foto: [
    ...
    { src: '/images/memory-2.jpeg', caption: 'Momen bersama' },
    { src: '/images/memory-3.jpeg', caption: 'Kenangan indah' },
    { src: '/images/memory-4.jpeg', caption: 'Aku ✈ ke Kendari' },
    { src: '/images/memory-5.jpeg', caption: 'Wisuda Ari!' },
    { src: '/images/memory-6.jpeg', caption: 'Kendari, rumah baru' },
    { src: '/images/memory-7.jpeg', caption: 'Tetap bertahan' },
    { src: '/images/memory-8.jpeg', caption: 'Hari ini' },
    { src: '/images/memory-extra-1.jpeg', caption: 'Momen spesial' },
    { src: '/images/memory-extra-2.jpeg', caption: 'Kebersamaan' },
    { src: '/images/memory-extra-3.jpeg', caption: 'Cerita kami' },
    { src: '/images/memory-extra-4.jpeg', caption: 'Bersama selalu' },
    { src: '/images/memory-extra-5.jpeg', caption: 'Kenang-kenangan' },
    { src: '/images/memory-extra-6.jpeg', caption: 'Untuk selamanya' },
  ],
}
